	...
	<div class="row">
		<form class="col-md-8" method="POST" enctype="multipart/form-data">
			...
			<div class="form-group row">
				...
				<div class="col-sm-10">
					<input type="text" class="form-control" name="Giuong" placeholder="Nhập loại giường" value="{{$loaiphong->Giuong}}" required="">
				</div>
			</div>
			<div class="form-group row">
				<label for="NguoiLon" class="col-sm-2 col-form-label">Người lớn</label>
				<div class="col-sm-10">
					<input type="number" class="form-control" name="NguoiLon" placeholder="Nhập số lượng"  value="{{$loaiphong->NguoiLon}}" required="">
				</div>
			</div>
			<div class="form-group row">
				<label for="TreCon" class="col-sm-2 col-form-label">Trẻ con</label>
				<div class="col-sm-10">
					<input type="number" class="form-control" name="TreCon" placeholder="Nhập số lượng"  value="{{$loaiphong->TreCon}}" required="">
				</div>
			</div>
			<div class="form-group row">
				<label for="DienTich" class="col-sm-2 col-form-label">Diện tích</label>
				<div class="col-sm-10">
					<input type="number" class="form-control" name="DienTich" placeholder="Nhập diện tích"  value="{{$loaiphong->DienTich}}" required="">
				</div>
			</div>
			<div class="form-group row">
				<label for="HuongNhin" class="col-sm-2 col-form-label">Hướng nhìn</label>
				<div class="col-sm-10">
					<input type="text" class="form-control" name="HuongNhin" placeholder="Hướng nhìn" value="{{$loaiphong->HuongNhin}}" required="">
				</div>
			</div>
			<div class="form-group row">
